...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='fir',
  ...
  def init(self, args=''):
    default_dataset_info = {
      'ctdet': {'default_resolution': [cf.train_size, cf.train_size],
                'num_classes': cf.ctdet_default_num_classes,
                'mean': cf.ctdet_default_mean, 'std': cf.ctdet_default_std,
                'dataset': cf.default_dataset},
